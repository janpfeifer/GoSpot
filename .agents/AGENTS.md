...
* Use modern Go constructs: `for range` loops; `any` instead of `interface{}`, the new iterators when it makes sense, generics for functionality that applies on different types, etc.
